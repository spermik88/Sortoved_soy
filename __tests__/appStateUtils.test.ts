      ...
      computeAggregateTraitState(
        {
          ...
          stem_length: 'completed',
          lower_pod_attachment_height: 'completed',
          productive_nodes_count: 'completed',
          branch_count: 'completed',
          productive_pods_count: 'completed',
          pods_per_productive_node: 'completed',
          seeds_per_plant: 'completed',
          seeds_per_pod: 'completed',
          seed_weight_per_plant: 'completed',
        },
        [
          'fusarium',
          'septoria',
